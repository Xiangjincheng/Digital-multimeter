...
{	
	INA226_setConfig(&hi2c1,0x80,0x8000);
	INA226_setConfig(&hi2c1,0x80,0x484f);
	INA226_setCalib(&hi2c1,0x80,456);
	INA226_getConfig(&hi2c1,0x80);
}
...
uint8_t INA226_setCalib(I2C_HandleTypeDef *I2CHandler, uint16_t DevAddress, uint16_t ConfigWord) {
	uint8_t SentTable[3];
